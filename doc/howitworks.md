...
![Toy data set consisting of various astro-like clusters.](../images/howitworks/data.png)
...
![Analogous process to AstroLink using probability distribution of toy data set.](../images/howitworks/analogous_process_with_probability_distribution.gif)
...
![Probability distribution with marked clusters.](../images/howitworks/probability_distribution_with_clusters.png)
...
![Toy data set with marked clusters from analogy.](../images/howitworks/data_with_clusters_from_analogy.png)
...
![Toy data set coloured by local-density.](../images/howitworks/data_coloured_by_logrho.png)
...
![Aggregation process applied to toy data set.](../images/howitworks/aggregation_process_with_probability_distribution.gif)
...
![The prominence distribution with fitted model.](../images/howitworks/fitted_prominences.png)
...
![Data and ordered-density plot coloured by statistical outliers.](../images/howitworks/data_and_ordered_density_plot_with_some_clusters.png)

> [!NOTE]
> AstroLink always includes an additional cluster equal to the entire data set. This allows AstroLink to be applied modularly to disjoint data sets.
...
![Data and ordered-density plot coloured by final clusters.](../images/howitworks/data_and_ordered_density_plot_with_final_clusters.png)
